...
export class ItemStore extends DurableObject<ItemStoreEnv> {
  constructor(ctx: DurableObjectState, env: ItemStoreEnv) {
    ...
    execSqlScript(this.ctx.storage.sql, `
      ...
      INSERT OR IGNORE INTO admin_group_permissions (group_id,resource,permission) VALUES ('group-main-admin','admin.dashboard','access'),('group-main-admin','admin.dashboard','modify'),('group-main-admin','admin.orders','access'),('group-main-admin','admin.orders','modify'),('group-main-admin','admin.production','access'),('group-main-admin','admin.production','modify'),('group-main-admin','admin.products.printify','access'),('group-main-admin','admin.products.printify','modify'),('group-main-admin','admin.users','access'),('group-main-admin','admin.users','modify'),('group-main-admin','admin.user_groups','access'),('group-main-admin','admin.user_groups','modify'),('group-main-admin','admin.settings','access'),('group-main-admin','admin.settings','modify');
...
[Showing lines 1-849 of 1747. Use offset=850 to continue.]