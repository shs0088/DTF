...
const report = {
  source_head: "bf19feae521be6273ddab35df259261fa6b10292",
  checks: {},
  metrics: {},
  console_errors: [],
  page_errors: [],
...
(async () => {
  ...
  try {
    ...
    report.visual_pass =
      ...
      report.network_errors.filter(e => e.status >= 500).length === 0;
  } catch (e) {
    ...
    fs.writeFileSync(
      ...
      [
        "M6 Visual QA",
        "Source M6 HEAD: bf19feae521be6273ddab35df259261fa6b10292",
